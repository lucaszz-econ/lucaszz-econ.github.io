...
* Continuous Difference-in-Differences with Double/Debiased Machine Learning. *(The Econometrics Journal, 2025)* [[Link]](https://doi.org/10.1093/ectj/utaf024){:target="_blank" rel="noopener"} [[Preprint]](https://arxiv.org/abs/2408.10509){:target="_blank" rel="noopener"}
