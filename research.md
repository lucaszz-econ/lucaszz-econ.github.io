...
* Continuous Difference-in-Differences with Double/Debiased Machine Learning. *(The Econometrics Journal, 2025)* [[Link]](https://doi.org/10.1093/ectj/utaf024){:target="_blank" rel="noopener"} [[Preprint Version]](https://arxiv.org/abs/2408.10509){:target="_blank" rel="noopener"}
  ...
  >
  > **Code & Replication Materials:**
  > * [Simulate Empirical Application Data](/notes/Simulate_empirical_data.html){:target="_blank" rel="noopener"}
  > * [Estimators & Empirical Application](/notes/dmlcdid.html){:target="_blank" rel="noopener"}
  > * [Monte Carlo Simulations](/notes/Simulation_Replication.html){:target="_blank" rel="noopener"}
  > * [Download Full Replication Package (.zip)](/notes/dmlcdid_replication_package.zip)
...
* An Oracle for Data-Driven High-Dimensional Conditional Density Estimation. *(Forthcoming!)* [[Dissertation Version (Chapter 2)]](https://escholarship.org/uc/item/9163f0mg){:target="_blank" rel="noopener"}
